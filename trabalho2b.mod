...
var entrega{Planet, Type, {0..NoMonths}}>=0;
...
maximize Revenue:
  ...
  -
    InventoryPricePerUnitP * sum {p in Planet,t in Type, m in {1..NoMonths}}
                  InventoryPlanet[p,t, m];
...
subject to
  ...
  ProductSell{p in Planet, t in Type, m in {1..NoMonths}}:
    entrega[p,t,m] <= InventoryPlanet[p,t,m] +  Exported[p, t, m];
  ...
  InventoryBalancePlanet{p in Planet,t in Type, m in {1..NoMonths}}:
    InventoryPlanet[p,t, m] = InventoryPlanet[p,t, m-1] + Exported[p,t,m] - entrega[p,t,m];
